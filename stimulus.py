...
class Stimulus:
	...
	def generate_trial(self, task_num=0):
		...
		# Populate primary task information
		current_task = self.task_types[task_num]	# Select a task from the list
		current_task[0](*current_task[1:])			# Generate that task in trial_info
